...
- ⚠️ **มีธุรกรรมทดสอบค้างใน Firestore 1 รายการ** (พบ 4 ก.ย.)
  `GbvAULaIs8GEqpv4ihw1` — ม.2 อดิเทพ สีทินอยู่ · ขวดพลาสติก 1 กก. 8 บาท 3 แต้ม
  บันทึกโดยครูวรุณพร วันที่ 2026-09-04 · **ตัดสินใจก่อน go-live ว่าจะลบหรือเก็บไว้**
  ลบผ่านเมนู "ประวัติรับซื้อ" ในหน้าเว็บได้เลย (ระบบจะย้ายไป `deletedTransactions` ให้)
