...
- ครูที่มีรหัสเดิม `1234` คงไว้ได้; **บัญชีที่รหัสว่างต้องตั้งใหม่** (Firebase บังคับอย่างน้อย 6 ตัวอักษร → รหัส `1234` เดิมใช้ไม่ได้ ต้องตั้งใหม่ทุกบัญชี เช่น `ecopink2569`) — จุดนี้ต้องแจ้งครูทุกคน
